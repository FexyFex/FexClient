package net.minecraft.src.texture;// Decompiled by Jad v1.5.8g. Copyright 2001 Pavel Kouznetsov.
...
public class TexturePackDefault extends TexturePackBase
{
    ...
    public TexturePackDefault()
    {
        ...
        firstDescriptionLine = "The default look of net.minecraft.client.Minecraft";
        try
        {
