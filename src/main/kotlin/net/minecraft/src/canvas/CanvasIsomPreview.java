...
import net.minecraft.src.enums.EnumOS1;
import net.minecraft.src.threading.ThreadRunIsoClient;
import net.minecraft.src.world.WorldIso;
...
public class CanvasIsomPreview extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
    ...
    public static boolean isRunning(CanvasIsomPreview canvasisompreview) {
