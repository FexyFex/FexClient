...
import net.minecraft.src.opengl.buffer.ImageBuffer;
import net.minecraft.src.texture.TextureFX;
import net.minecraft.src.texture.TexturePackBase;
import net.minecraft.src.texture.TexturePackList;
import net.minecraft.src.threading.ThreadDownloadImageData;
