...
public class BlockPortal extends BlockBreakable {
    ...
    public boolean tryToCreatePortal(World world, int i, int j, int k) {
        int l = 0;
        int i1 = 0;
        if (world.getBlockId(i - 1, j, k) == obsidian.blockID || world.getBlockId(i + 1, j, k) == obsidian.blockID) {
            l = 1;
        }
        if (world.getBlockId(i, j, k - 1) == obsidian.blockID || world.getBlockId(i, j, k + 1) == obsidian.blockID) {
            i1 = 1;
        }
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, int l) {
        ...
        if ((world.getBlockId(i + i1, j, k + j1) != obsidian.blockID || world.getBlockId(i - i1, j, k - j1) != blockID) && (world.getBlockId(i - i1, j, k - j1) != obsidian.blockID || world.getBlockId(i + i1, j, k + j1) != blockID)) {
            world.setBlockWithNotify(i, j, k, 0);
            return;
        } else {
            return;
