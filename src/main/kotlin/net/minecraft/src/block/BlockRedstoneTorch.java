...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        ...
        if(torchActive)
        {
            if(flag)
            {
                world.setBlockAndMetadataWithNotify(i, j, k, torchRedstoneIdle.blockID, world.getBlockMetadata(i, j, k));
        ...
        {
            world.setBlockAndMetadataWithNotify(i, j, k, torchRedstoneActive.blockID, world.getBlockMetadata(i, j, k));
        }
    }
