...
public class EntityItem extends Entity
{
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setCompoundTag("net.minecraft.src.item.Item", item.writeToNBT(new NBTTagCompound()));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        NBTTagCompound nbttagcompound1 = nbttagcompound.getCompoundTag("net.minecraft.src.item.Item");
