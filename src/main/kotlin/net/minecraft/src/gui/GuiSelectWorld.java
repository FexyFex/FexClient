...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for(int i = 0; i < 5; i++)
        {
            NBTTagCompound nbttagcompound = World.func_629_a(file, (new StringBuilder()).append("net.minecraft.src.blocks.World").append(i + 1).toString());
    ...
    {
        java.io.File file = Minecraft.getMinecraftDir();
        return World.func_629_a(file, (new StringBuilder()).append("net.minecraft.src.blocks.World").append(i).toString()) == null ? null : (new StringBuilder()).append("net.minecraft.src.blocks.World").append(i).toString();
    }
    ...
    public void selectWorld(int i)
    {
        ...
        } else
        {
            ...
            mc.func_6247_b((new StringBuilder()).append("net.minecraft.src.blocks.World").append(i).toString());
            mc.displayGuiScreen(null);
            return;
        }
    }
