...
import net.minecraft.src.canvas.CanvasCrashReport;
import net.minecraft.src.canvas.CanvasMajongLogo;
...
public class PanelCrashReport extends Panel {
    ...
    public PanelCrashReport(UnexpectedThrowable unexpectedthrowable) {
        ...
        try {
            ...
            s2 = (new StringBuilder()).append(s2).append("net.minecraft.client.Minecraft: net.minecraft.client.Minecraft Beta 1.1_02\n").toString();
        ...
        if (s.contains("Pixel format not accelerated")) {
            ...
            s3 = (new StringBuilder()).append(s3).append("      -----------------------      \n").toString();
            s3 = (new StringBuilder()).append(s3).append("\n").toString();
            s3 = (new StringBuilder()).append(s3).append("net.minecraft.client.Minecraft was unable to start because it failed to find an accelerated OpenGL mode.\n").toString();
            ...
            s3 = (new StringBuilder()).append(s3).append("      net.minecraft.client.Minecraft has crashed!      \n").toString();
            s3 = (new StringBuilder()).append(s3).append("      ----------------------      \n").toString();
            s3 = (new StringBuilder()).append(s3).append("\n").toString();
            s3 = (new StringBuilder()).append(s3).append("net.minecraft.client.Minecraft has stopped running because it encountered a problem.\n").toString();
            s3 = (new StringBuilder()).append(s3).append("\n").toString();
