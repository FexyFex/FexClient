...
public class ThreadDownloadResources extends Thread
{
    ...
    private void downloadAndInstallResource(URL url, String s, long l, int i)
    {
        ...
        {
            // Don't print. It will be annoying!
            //exception.printStackTrace();
        }
    }

    private void downloadResource(URL url, File file, long l) throws IOException {
        // Do not attempt to download! It will fail and produce many errors. Just throw right away
        throw new ConnectException("Resources no longer available for download");
        /*
