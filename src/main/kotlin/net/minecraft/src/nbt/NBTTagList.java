package net.minecraft.src.nbt;// Decompiled by Jad v1.5.8g. Copyright 2001 Pavel Kouznetsov.
...
public class NBTTagList extends NBTBase
{
    ...
    {
        return (new StringBuilder()).append("").append(tagList.size()).append(" entries of type ").append(getTagName(tagType)).toString();
    }
