...
- Put the name of the classes you want to be obfuscated, one per line. If you create new classes, they have to be specified as well.
  The name of the classes are the clear ones (net.minecraft.src.Block, net.minecraft.src.block.BlockDoor, etc).
  One example would be :
  net.minecraft.src.block.BlockDoor
  net.minecraft.src.Block
  net.minecraft.src.entity.Entity
  net.minecraft.src.world.chunk.ChunkProviderGenerate
  MyNewAwesomeClass
